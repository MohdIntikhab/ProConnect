...
<div className={"education"}>
      ...
      Add Education
...

       {
          ...
          <div onClick={()=>{
            ...
            <div onClick={(e)=>{
              e.stopPropagation() // This is help in to restrict the propogate to its parent 
            }} 
            className={styles.allcommenstContainer}>
  ...
  <div onClick={() => setIsEduModalOpen(false)} className={styles.commentsContainer}>
    ...
    <div onClick={(e) => e.stopPropagation()} className={styles.allcommenstContainer}>
